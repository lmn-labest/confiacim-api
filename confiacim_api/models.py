...
class TencimResult(TimestampMixin, Base):
    ...
    istep: Mapped[Optional[TArrayInt]] = mapped_column(ARRAY(Integer, as_tuple=True), deferred=True)
    t: Mapped[Optional[TArrayFloat]] = mapped_column(ARRAY(Float, as_tuple=True), deferred=True)
    rankine_rc: Mapped[Optional[TArrayFloat]] = mapped_column(ARRAY(Float, as_tuple=True), deferred=True)
    mohr_coulomb_rc: Mapped[Optional[TArrayFloat]] = mapped_column(ARRAY(Float, as_tuple=True), deferred=True)
...
class HidrationPropInfos(TimestampMixin, Base):
    ...
    E_c_t: Mapped[Optional[TArrayFloat]] = mapped_column(ARRAY(Float, as_tuple=True), deferred=True)
    E_c_values: Mapped[Optional[TArrayFloat]] = mapped_column(ARRAY(Float, as_tuple=True), deferred=True)

    poisson_c_t: Mapped[Optional[TArrayFloat]] = mapped_column(ARRAY(Float, as_tuple=True), deferred=True)
    poisson_c_values: Mapped[Optional[TArrayFloat]] = mapped_column(ARRAY(Float, as_tuple=True), deferred=True)

    cohesion_c_t: Mapped[Optional[TArrayFloat]] = mapped_column(ARRAY(Float, as_tuple=True), deferred=True)
    cohesion_c_values: Mapped[Optional[TArrayFloat]] = mapped_column(ARRAY(Float, as_tuple=True), deferred=True)
